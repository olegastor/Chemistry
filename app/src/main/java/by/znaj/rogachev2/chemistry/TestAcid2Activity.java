...
public class TestAcid2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_acid2);
        ...
        cursorOxides = db.rawQuery("select * from " + DatabaseHelper.TABLE_ACIDS2 + " ORDER BY RANDOM() LIMIT 10", null);
    ...
    public void nextQuestion() {
        ...
        cursorAnswers = db.rawQuery("select * from " + DatabaseHelper.TABLE_ACIDS2_ANSWERS + " where " + DatabaseHelper.COLUMN_ID_ACID + "=? ORDER BY RANDOM()", new String[]{String.valueOf(oxideId)});
